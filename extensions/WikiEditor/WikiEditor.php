...
$wgResourceModules += array(
	...
	'jquery.wikiEditor.toolbar.i18n' => $wikiEditorTpl + array(
		'messages' => array(
			...
			/* Toolbar - GC Additions */
			'wikieditor-toolbar-tool-strike',
			'wikieditor-toolbar-tool-underline',
			'wikieditor-toolbar-tool-center',
			'wikieditor-toolbar-align-right',
			'wikieditor-toolbar-align-left',
			'wikieditor-toolbar-tool-advanced-image',
			'wikieditor-toolbar-tool-horizontal-line',
			'wikieditor-toolbar-tool-math',
			'wikieditor-toolbar-tool-comment',
