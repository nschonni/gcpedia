...
class SwitchExperimentPrefs extends Maintenance {
	function __construct() {
		...
		$this->mDescription = 'Set a preference for all users that have the gcvector-noexperiments preference enabled.';
	}
	...
	function execute() {
		...
		while ( true ) {
			$res = $dbw->select( 'user_properties', array( 'up_user' ),
				array( 'up_property' => 'gcvector-noexperiments', "up_user > $lastUserID" ),
				__METHOD__,
