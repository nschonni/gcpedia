	...
	<body style ="background-color:white;">
		...
		<div id="globalWrapper">
				<div style="margin:auto;
					...
					">
					<?php ?>
					<h2 st/yle="font-size:133%; background-color: #ac1a2f; color: white; padding-left:7px;"><?php if ( $wgLang->getCode() == 'en' ) echo "Welcome"; else echo "Bienvenue";?>, <?php if ( $wgUser->getRealName() != '' ) echo $wgUser->getRealName(); else echo $wgUser->getName(); ?></h1>
					...
					<br />
					<!-- Instructions -->
					<p style="padding: 0 0 0 7px;"> <?php echo wfMsg( 'disclaimer-instruc' ); ?> </p>
