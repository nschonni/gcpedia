<?php
/**
 * GCVector - Modern version of MonoBook with fresh look and many usability
 * improvements.
 *
...
$wgResourceModules['skins.gcvector'] = array(
	'styles' => array(
		'common/commonElements.css' => array( 'media' => 'screen' ),
		'common/commonContent.css' => array( 'media' => 'screen' ),
		'common/commonInterface.css' => array( 'media' => 'screen' ),
		'gcvector/screen.css' => array( 'media' => 'screen' ),
		'gcvector/screen-hd.css' => array( 'media' => 'screen and (min-width: 982px)' ),
	),
	'scripts' => 'gcvector/gcvector.js',
	'remoteBasePath' => &$GLOBALS['wgStylePath'],
	'localBasePath' => &$GLOBALS['wgStyleDirectory'],
);

/**
 * SkinTemplate class for GCVector skin
 * @ingroup Skins
 */
class SkinGCVector extends SkinTemplate {

	protected static $bodyClasses = array( 'gcvector-animateLayout' );

	var $skinname = 'gcvector', $stylename = 'gcvector',
		$template = 'GCVectorTemplate', $useHeadElement = true;
	...
	public function initPage( OutputPage $out ) {
		...
		$out->addModuleScripts( 'skins.gcvector' );
	}
	...
	function setupSkinUserCss( OutputPage $out ){
		...
		$out->addModuleStyles( 'skins.gcvector' );
	}
...
/**
 * QuickTemplate class for GCVector skin
 * @ingroup Skins
 */
class GCVectorTemplate extends BaseTemplate {
	...
	public function execute() {
		global $wgGCVectorUseIconWatch;

		// Build additional attributes for navigation urls
		$nav = $this->data['content_navigation'];

		if ( $wgGCVectorUseIconWatch ) {
...
<?php
	...
	protected function renderNavigation( $elements ) {
		global $wgGCVectorUseSimpleSearch;
		...
		foreach ( $elements as $name => $element ) {
			...
			switch ( $element ) {
				case 'NAMESPACES':
?>
<div id="p-namespaces" class="gcvectorTabs<?php if ( count( $this->data['namespace_urls'] ) == 0 ) echo ' emptyPortlet'; ?>">
...
<?php
				...
				case 'VARIANTS':
?>
<div id="p-variants" class="gcvectorMenu<?php if ( count( $this->data['variant_urls'] ) == 0 ) echo ' emptyPortlet'; ?>">
	<h4>
...
<?php
				...
				case 'VIEWS':
?>
<div id="p-views" class="gcvectorTabs<?php if ( count( $this->data['view_urls'] ) == 0 ) { echo ' emptyPortlet'; } ?>">
...
<?php
				...
				case 'ACTIONS':
?>
<div id="p-cactions" class="gcvectorTabs<?php if ( count( $this->data['action_urls'] ) == 0 ) { echo ' emptyPortlet'; } ?>" style="margin-left: 0.35em;">
...
<div id="p-search">
	...
	<form action="<?php $this->text( 'wgScript' ) ?>" id="searchform">
		<?php if ( $wgGCVectorUseSimpleSearch && $this->getSkin()->getUser()->getOption( 'gcvector-simplesearch' ) ): ?>
		<div id="simpleSearch">
